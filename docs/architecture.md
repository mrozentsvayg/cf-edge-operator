...
| `cf_edge_operator_customhostname_status{zone_cr,status}` | gauge | Managed CF custom hostnames by zone CR and CF activation status (active/pending/active_redeploying/blocked/moved). Only includes hostnames with an associated CR. |
